...
export const ProfileHeader: React.FC<ProfileHeaderProps> = ({ profile, onBack }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <Text style={styles.headerTitle}>Field Profile</Text>
      ...
      <View style={styles.profileBox}>
        <View style={styles.avatarWrap}>
          <Text style={styles.avatarText}>{initials || 'EN'}</Text>
