...
import { AnomalyFilterCategory } from '../../types/anomalyTypes';

interface AnomalyFilterBarProps {
  selectedCategory: AnomalyFilterCategory;
  onSelectCategory: (cat: AnomalyFilterCategory) => void;
  counts: Record<AnomalyFilterCategory, number>;
}

const CATEGORIES: AnomalyFilterCategory[] = [
  'All',
  'Critical',
  'High',
  'Medium',
