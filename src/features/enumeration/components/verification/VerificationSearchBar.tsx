...
import { VerificationSortOption } from '../../types/verificationTypes';

interface VerificationSearchBarProps {
  value: string;
  onChangeText: (text: string) => void;
  onClear: () => void;
  sortOption: VerificationSortOption;
  onSelectSort: (sort: VerificationSortOption) => void;
}

export const VerificationSearchBar: React.FC<VerificationSearchBarProps> = ({
  value,
  onChangeText,
  onClear,
  sortOption,
  ...
  const nextSort = (): VerificationSortOption => {
    if (sortOption === 'Priority') return 'Household ID';
    ...
    <View style={styles.container}>
      <View style={styles.searchWrap}>
        ...
        <TextInput
          ...
          placeholder="Search household ID, head name, locality, mobile..."
